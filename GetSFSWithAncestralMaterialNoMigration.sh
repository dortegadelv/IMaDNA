...
./im_clam -s stateSpaceFiles/testSS_22 -m stateSpaceFiles/testSS_22_mats -exp -x $FractionN2,$FractionNa,$MigRateOneToTwo,$MigRateTwoToOne,$MsDivTime > $OutputSFS
...
./im_clam -s stateSpaceFiles/ss_1_3 -m stateSpaceFiles/ss_1_3_mats -exp -x $FractionN2,$FractionNa,$MigRateOneToTwo,$MigRateTwoToOne,$MsDivTime > $OutputSFS
...
./im_clam -s stateSpaceFiles/ss_1_4 -m stateSpaceFiles/ss_1_4_mats -exp -x $FractionN2,$FractionNa,$MigRateOneToTwo,$MigRateTwoToOne,$MsDivTime > $OutputSFS
...
./im_clam -s stateSpaceFiles/ss_1_2 -m stateSpaceFiles/ss_1_2_mats -exp -x $FractionN2,$FractionNa,$MigRateOneToTwo,$MigRateTwoToOne,$MsDivTime > $OutputSFS
...
Rscript --vanilla CoalTimePresentBeforeAncestral.R $mOne $mTwo $ThetaOne $ThetaTwo $AncTime $DivisionsInCoalescentCalculations 6 $MutationRate $OutputProportions
...
perl CalculateSFSUsingAllData.pl $OutputProportions $PrefixIMCLAM $OutputFinalSFS
