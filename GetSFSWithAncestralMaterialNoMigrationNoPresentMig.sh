...
Rscript --vanilla /opt/IMaDNA/CoalTimePresentBeforeAncestral.R 0.0 0.0 $ThetaOne $ThetaTwo $AncTime $DivisionsInCoalescentCalculations 6 $MutationRate $OutputProportions
